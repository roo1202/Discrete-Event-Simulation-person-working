...
\begin{figure}[H] % ht indica que la figura puede ir "aquí" o en la "parte superior" 
    ...
    \includegraphics[width=7cm, height=5cm]{Tareas_tiempotareas.png} % Inserta la imagen 
...
\begin{figure}[H] % ht indica que la figura puede ir "aquí" o en la "parte superior" 
    \centering % Centra la imagen en la página 
    \includegraphics[width=7cm, height=5cm]{tareas_interrupciones.png} % Inserta la imagen 
